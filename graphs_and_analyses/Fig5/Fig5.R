...
perms2 <- read.csv("Filepath\\exp2400.csv")
colnames(perms2) <- c("X","exp2")
perms3 <- read.csv("Filepath\\exp2401.csv")
colnames(perms3) <- c("X","exp3")
perms4 <- read.csv("Filepath\\exp2402.csv")
colnames(perms4) <- c("X","exp4")
perms5 <- read.csv("Filepath\\exp2403.csv")
colnames(perms5) <- c("X","exp5")
obs <- read.csv("Filepath\\obs.csv")
